...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['resetpass'])) {
    ...
    if (empty($_POST['email']) || empty($_POST['newpass']) || empty($_POST['confirm-pass'])) {
        echo "Please fill out all fields.";
    } else {
        // Sanitize inputs
        $email = sanitizeInput($_POST['email']);
        $newPassword = sanitizeInput($_POST['newpass']);
        $confirmPassword = sanitizeInput($_POST['confirm-pass']);
...
?>
                ...
                <form  action="" method="POST"> 
                  ...
                  <div class="text-center">
                    <button type="submit" name= "resetpass" class="btn bg-gradient-dark w-100 my-4 mb-2">Change Password</button> 
                  </div>
                </form>
              </div>
            </div>
