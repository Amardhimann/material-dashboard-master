...
?>
<?php
require 'admin-files/header.php';//header files
?>
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active bg-gradient-dark text-white" href="admin/dashboard.php">
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card">
            <div class="card-body">
              ...
              <div class="pe-2">
                <div class="chart">
                  <canvas id="chart-bars" class="chart-canvas" height="170" width="257" style="display: block; box-sizing: border-box; height: 170px; width: 257px;"></canvas>
                </div>
              </div>
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card ">
            <div class="card-body">
              ...
              <div class="pe-2">
                <div class="chart">
                  <canvas id="chart-line" class="chart-canvas" height="170" width="257" style="display: block; box-sizing: border-box; height: 170px; width: 257px;"></canvas>
                </div>
              </div>
              <hr class="dark horizontal">
              <div class="d-flex ">
        ...
        <div class="col-lg-4 mt-4 mb-3">
          <div class="card">
            <div class="card-body">
              ...
              <div class="pe-2">
                <div class="chart">
                  <canvas id="chart-line-tasks" class="chart-canvas" height="170" width="257" style="display: block; box-sizing: border-box; height: 170px; width: 257px;"></canvas>
                </div>
              </div>
              <hr class="dark horizontal">
              <div class="d-flex ">
...
require 'admin-files/footer.php';
